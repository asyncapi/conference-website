...
const Guidelines: React.FC<GuidelinesProps> = ({ talkDeadLine, virtual, name, cfp }) => {
  ...
  return (
    <div className="z-[9]" data-test="guideline-com">
      <div className="flex flex-col justify-center">
        <Heading className="text-[60px] text-white text-center">Speakers Guideline</Heading>
        <div className="mt-20">
          {faqs.map((faq, i) => (
            <div key={faq.q} onClick={() => toggleShow(i)}>
              ...
              >
                ...
                {i === 2 && faq.a1 && faq.a2 ? (
                  <p
                    className={`mt-8 text-md text-white ${
                      show === i ? 'block' : 'hidden'
                    }`}
                  >
