              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-md text-white overflow-hidden transition-all duration-500 ease-in-out transform ${show === i ? 'mt-8 max-h-250 opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2'}`}
                    >
