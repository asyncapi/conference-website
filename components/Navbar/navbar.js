                ...
                <div href={link.ref} key={link.title}>
                  ...
                  >
                    ...
                    {show === link.title && link.subMenu && (
                      <div
                        className="subMenu absolute z-[9] mt-8 w-[170px] rounded-md left-[-15px] gradient-bg flex flex-col justify-center border border-gray-300 mt-2 p-2"
                        ...
                        {link.subMenu.map((subL) => (
                          <Link href={subL.ref} key={subL.title}>
                            {link.subMenu.length === 1 ? (
                              ...
                              <div className="h-[32px] text-[16px] hover:scale-95 hover:translate-x-1 transition-all border-b-2 p-1 flex items-center">
                                <img
                                  src="/img/mapIcon2.svg"
