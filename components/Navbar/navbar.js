                ...
                <div href={link.ref} key={link.title}>
                  ...
                  >
                    ...
                    {show === link.title && link.subMenu && (
                      <div
                        className="subMenu absolute z-[9] mt-8 w-[200px] rounded-md left-[-15px] px-2 py-1 flex flex-col justify-center space-y-0 bg-slate-800"
                      ...
                      >
                        {link.subMenu.map((subL) => (
                          ...
                          >
                            <div
                              className={`flex items-center ${link.subMenu.length === 1 ? "justify-center" : "justify-start"} min-h-[32px] text-[16px] hover:scale-1000 hover:translate-x-1 transition-all`}
