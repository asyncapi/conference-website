  ...
  return (
    <div className="flex justify-between p-5 border-0 border-b border-dark-gray h-[84px] sticky top-0 w-full navbar">
      ...
      <div className="flex items-center justify-end text-white w-[50%]">
        <span className="font-secondary text-white text-[16px] tracking-[0.03em] mr-4 font-semibold">About</span>
        <span className="font-secondary text-white text-[16px] tracking-[0.03em] mr-4 font-semibold">Venue</span>
        <span className="font-secondary text-white text-[16px] tracking-[0.03em] mr-4 font-semibold">Speakers</span>
        <span className="font-secondary text-white text-[16px] tracking-[0.03em] mr-4 font-semibold">Sponsors</span>
        {/* <Button
