...
function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-white py-6 px-2">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-8">
          ...
          <div className="flex gap-96">
            ...
            <div className="items-center md:justify-end relative top-[-113px]">
        ...
        <div className="border-t border-gray-700 mt-0 pt-6 flex flex-col justify-between items-center">
