...
function Footer(): JSX.Element {
  return (
    <div className="container" data-test="footer">
      <div
        className="w-full flex flex-row justify-between items-center p-2 md:p-4 gap-1 md:gap-4 flex-wrap"
        data-test="footer-asyncAPI-logo"
      >
        {/* Code of Conduct Section */}
        <div className="text-[10px] md:text-[16px] text-gray-100 flex items-center flex-shrink-0">
          <a
          ...
          >
            ...
            <ILink className="w-2 md:w-4 ml-1 md:ml-2" fill="white" />
          </a>
        </div>

        {/* "Made with ❤️" and Socials Section - Grouped together */}
        <div className="flex flex-row items-center gap-1 md:gap-4 text-center">
          <span className="text-white text-[10px] md:text-[16px] leading-tight">
            Made with ❤️ by AsyncAPI contributors. By the community for the community!
          </span>
          <div className="w-[1px] h-3 md:h-6 bg-white" />
