...
function Subcription() {
  return (
		<div className='mt-[106px] subscription container flex justify-center'>
			<div className='w-[1024px] flex flex-col items-center mt-[106px]'>
            ...
            type='email'
					/>
					<button className='w-[299px] bg-[#875AE2] h-[84px] text-[24px] text-white rounded-r-lg'>Subscribe</button>
				</form>
			</div>
		</div>
	);
