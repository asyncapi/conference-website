    ...
    <form onSubmit={(e) => setStep(e, 4)} data-test="reg-step-three">
      ...
      <div role="group" className='space-y-2' aria-labelledby="step-three-heading">
        <fieldset className='space-y-2'>
          ...
          <div className="text-white">
            <input
              ...
              className="mr-2 focus:ring-2 focus:ring-brand-pink"
            />
        ...
        <div className='space-y-1'>
          ...
          <textarea
            id="notes"
            className="mt-3 w-full p-4 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-pink focus:ring-offset-2 focus:ring-offset-gray-900 border border-brand-pink"
            value={notes}
