...
function StepTwo({ setStep, setForm, data }: StepTwoProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-10">
        <label className="text-dark-600 text-lg block">Session Title</label>
        <input
          required
        ...
        <label className="text-dark-600 text-lg mt-4 block">
          Session Description
        </label>
        <textarea
          required
