  ...
  return (
    <Link href={`/venue/${city.name}`}>
      <div
        ...
        className="relative w-72 h-96 sm:w-64 sm:h-80 card-bg rounded-2xl flex items-center justify-center p-4 cursor-pointer m-3 hover:scale-105 hover:shadow-xl transition-transform duration-300 ease-in-out"
      >
