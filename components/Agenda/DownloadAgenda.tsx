...
const styles = StyleSheet.create({
  ...
  // ✅ Footer perfectly centered and slightly higher
  footer: {
    position: 'absolute',
    bottom: 25,
    left: 0,
...
// ✅ Helper: clean up agenda time strings
    ...
    <Document>
      <Page style={styles.page}>
        ...
        <Text style={styles.footer}>
          Generated by AsyncAPI Conference App © {new Date().getFullYear()}
        </Text>
      </Page>
    </Document>
  );
