...
import { Sponsor } from "../../types/type";
...
function Sponsors({ eventSponsors, financialSponsor }: SponsorsProps) {
  // eventSponsors, financialSponsor = [{ image: 'url', websiteUrl: 'url', className: 'string' }]
  return (
    <div className="sponsor-bg container text-center" data-test="sponsor-section">
      <div className="py-[80px] flex flex-col items-center">
        ...
        <Heading typeStyle="heading-md" className="text-white mt-10 sm:text-2xl sm:mt-5">
