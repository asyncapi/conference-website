          ...
          return (
            ...
            >
              <div className="pb-4 cursor-pointer mt-4 border border-charcoal p-4 rounded-xl">
                ...
                {
                  <p
                    className={`text-md text-white overflow-hidden transition-all duration-500 ease-in-out transform ${show === i ? 'mt-2 max-h-250 opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2'}`}
                  >
                    {q.a}
                  </p>
                }
