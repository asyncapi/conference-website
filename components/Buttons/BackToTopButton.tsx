  ...
  return isVisible ? (
    ...
    >
      <Arrows
        ...
        fill="white"
      />
      <span className="absolute text-white text-xs opacity-0 whitespace-nowrap transition-all duration-300 ease-in-out group-hover:text-xs group-hover:opacity-100">
        Back to Top
      </span>
    </button>
  ) : null;
