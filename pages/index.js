      ...
      <div className='flex mt-[150px] lg:mt-[50px] sm:items-center lg:flex-col'>
        ...
        <div className='p-9 bg-tetiary-pink w-[480px] lg:w-[50%] sm:w-[80%] h-[300px] sm:h-[auto] sm:ml-[0px] lg:ml-[100px] text-right lg:text-center z-[2]'>
          <p className='text-md'>LONDON EDITION In <br /> IBM UK LIMITED</p>
            <div>
              <a target="_blank" rel="noopener noreferrer" href="https://calendar.google.com/calendar/u/0/embed?src=c_q9tseiglomdsj6njuhvbpts11c@group.calendar.google.com&ctz=UTC"><button className='mt-12 bg-white border border-black p-2 text-lg rounded-3xl'>September 20, 2023</button></a>
          </div>
        </div>
