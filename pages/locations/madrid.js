    ...
    <>
      <div className=' w-full h-screen bg-[url("/img/Spain.png")] bg-contain bg-no-repeat '>
        <div className=" bg-black bg-opacity-60 h-full">
          <div className=" h-[80vh] flex text-center">
            <div className=" my-auto mx-auto">
              ...
              <p className=" text-white text-xl">
                ...
                fluent API! Let's taco <br /> 'bout messaging and have a fiesta
                you won't forget!
              </p>
          ...
          <div className=" my-auto flex  justify-center">
            <button onClick={() => scrollToSection('section1')} className=" w-[7rem] mx-8">
              <p className=" p-3 border-2 border-white bg-white bg-opacity-10 rounded-sm text-white font-semibold">
                About
              </p>
            </button>
            <button onClick={() => scrollToSection('section2')} className=" w-[7rem] mx-8">
              <p className=" p-3 border-2 border-white bg-white bg-opacity-10 rounded-sm text-white font-semibold">
                Agenda
              </p>
            </button>
            <button onClick={() => scrollToSection('section3')} className=" w-[7rem] mx-8">
              <p className=" p-3 border-2 border-white bg-white bg-opacity-10 rounded-sm text-white font-semibold">
                Speakers
              </p>
            </button>
            <button onClick={() => scrollToSection('section4')} className=" w-[7rem] mx-8">
              <p className=" p-3 border-2 border-white bg-white bg-opacity-10 rounded-sm text-white font-semibold">
                Sponsors
              </p>
            </button>
      ...
      <div className=" w-full h-[20vh] flex items-center pl-10 border-b border-dark-gray">
        <div className=" flex ">
          ...
          <button className="relative flex w-60 justify-center items-center bg-white bg-opacity-10 border-2 border-blueGray-700 focus:outline-none shadow text-gray-600 rounded "
            ...
            <div className=" flex mb-10">
              ...
              <div className=" mr-10">
                ...
                <h2 className=" text-base font-semibold">
                  The Power of APIs: Driving Innovation <br /> and Collaboration
                </h2>
              </div>
              <div className=" flex">
                {/* image */}
